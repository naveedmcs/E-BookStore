...
open class NvPicker {
    ...
    private static let sharedInstance = NvPicker()
    ...
    */
    ...
    private class func controller(title: String? = nil,
        ...
        if let cc = UIWindow.currentController {
            if NvPicker.sharedInstance.isPresented == false {
                NvPicker.sharedInstance.isPresented = true
                ...
                vc.onWillDismiss = {
                    NvPicker.sharedInstance.isPresented = false
                }
